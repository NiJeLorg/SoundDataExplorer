...
"""
  Finds nearest personal weather station from WU API
"""
class Command(BaseCommand):
	...
	def personal_weather_station_lookup(self):
		...
		beaches = Beaches.objects.filter(id__in=[1889, 1888, 1883])
	...
	def handle(self, *args, **options):
		...
		self.personal_weather_station_lookup()
		print "Done."
